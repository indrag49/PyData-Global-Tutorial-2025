...
- Note that running the notebook from Google Colab might be comparatively slower than running it on your own local machine. Does not make much of a difference though!
